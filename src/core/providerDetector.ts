...
import type { ProviderSpec, ProviderLoginCheck } from '../provider-hub/ProviderTypes';
import { PROVIDER_SPECS } from '../provider-hub/ProviderSpecRegistry';

// Re-export for backward compatibility
export type { ProviderAuthStatus } from '../provider-hub/ProviderTypes';
import type { ProviderAuthStatus } from '../provider-hub/ProviderTypes';
...
// Keep SPECS as a local alias for backward compat within this file
const SPECS = PROVIDER_SPECS;
